(function() {
  ...
  module.exports = Highlights = (function() {
    ...
    Highlights.prototype._highlightCommon = function(_arg) {
      var fileContents, filePath, grammar, html, i, lastLineTokens, lineNumbers, lineTokens, scopeName, scopeStack, scopes, tokens, value, _i, _j, _len, _len1, _ref, _ref1;
      _ref = _arg != null ? _arg : {}, filePath = _ref.filePath, fileContents = _ref.fileContents, scopeName = _ref.scopeName;
      ...
      html = '<div class="code">\n\t<ol>\n';
      lineNumbers = '<div class="line-numbers">\n\t<ol>\n';
      for (i = _i = 0, _len = lineTokens.length; _i < _len; i = ++_i) {
        tokens = lineTokens[i];
        scopeStack = [];
        html += "\t\t<li class=\"line\" id=\"L" + (i + 1) + "\">";
        lineNumbers += "\t\t<li><a href=\"#L" + (i + 1) + "\"></a></li>\n";
