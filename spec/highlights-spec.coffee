...
describe "Highlights", ->
  describe "when an includePath is specified", ->
    it "includes the grammar when the path is a file", ->
      ...
      expect(html).toBe '<pre class="editor editor-colors"><div class="line" id="L1"><span class="include1"><span>test</span></span></div></pre>'
    ...
    it "overrides built-in grammars", ->
      ...
      expect(html).toBe '<pre class="editor editor-colors"><div class="line" id="L1"><span class="source coffee"><span>s&nbsp;=&nbsp;&quot;test&quot;</span></span></div></pre>'

  describe "highlightSync", ->
    it "returns an HTML string", ->
      highlights = new Highlights()
      html = highlights.highlightSync(fileContents: 'test')
      expect(html).toBe '<pre class="editor editor-colors"><div class="line" id="L1"><span class="text plain null-grammar"><span>test</span></span></div></pre>'
    ...
    it "uses the given scope name as the grammar to tokenize with", ->
      ...
      expect(html).toBe '<pre class="editor editor-colors"><div class="line" id="L1"><span class="source coffee"><span>test</span></span></div></pre>'
