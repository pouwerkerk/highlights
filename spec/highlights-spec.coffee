...
describe "Highlights", ->
  describe "when an includePath is specified", ->
    it "includes the grammar when the path is a file", ->
      ...
      expect(html).toBe '<ul class="source-code"><li class="line" id="L1"><span class="line-numbers"><a href="#L1"></a></span><span class="code"><span class="include1"><span>test</span></span></span></li></ul>'
    ...
    it "overrides built-in grammars", ->
      ...
      expect(html).toBe '<ul class="source-code"><li class="line" id="L1"><span class="line-numbers"><a href="#L1"></a></span><span class="code"><span class="source coffee"><span>s&nbsp;=&nbsp;&quot;test&quot;</span></span></span></li></ul>'

  describe "highlightSync", ->
    it "returns an HTML string", ->
      highlights = new Highlights()
      html = highlights.highlightSync(fileContents: 'test')
      expect(html).toBe '<ul class="source-code"><li class="line" id="L1"><span class="line-numbers"><a href="#L1"></a></span><span class="code"><span class="text plain null-grammar"><span>test</span></span></span></li></ul>'
    ...
    it "uses the given scope name as the grammar to tokenize with", ->
      ...
      expect(html).toBe '<ul class="source-code"><li class="line" id="L1"><span class="line-numbers"><a href="#L1"></a></span><span class="code"><span class="source coffee"><span>test</span></span></span></li></ul>'
